...
console.log(`We have ${new Set(staff).size} positions.`);
...
for (const day of days) {
  ...
  console.log(`Ib ${day}, we open at ${open}`);
}
...
// Logical operators can use any data type, return ANY data type, and they can do short-circuiting
console.log(3 || 'Jonas');
console.log('' || 'Jonas');
console.log(true || 0);
